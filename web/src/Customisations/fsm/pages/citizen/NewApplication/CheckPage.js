        ...
        <StatusTable>
          {selectTripNo && selectTripNo?.tripNo && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo="/digit-ui/citizen/fsm/new-application/select-trip-number" />
              }
            />
          )}
          ...
          {address?.landmark?.trim() && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo="/digit-ui/citizen/fsm/new-application/landmark" />
              }
            />
          )}
          {address?.slumArea?.code === true && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo="/digit-ui/citizen/fsm/new-application/slum-details" />
              }
            />
          )}
          {pitType && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo="/digit-ui/citizen/fsm/new-application/pit-type" />
              }
            />
          )}
          {pitMeasurement && (
            <Row
              ...
              text={[pitMeasurement]}
              actionButton={
                <ActionButton jumpTo="/digit-ui/citizen/fsm/new-application/tank-size" />
              }
            />
          )}
